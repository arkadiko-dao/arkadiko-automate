...
(define-read-only (check-job)
  (let (
    (end-epoch-block u0);; (contract-call? 'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-liquidation-rewards-diko-v1-1 get-end-epoch-block))
  )
...
(define-public (run-job)
  (begin
    (asserts! (unwrap! (check-job) (ok false)) (ok false))
