                    ...
                    <div className="ml-3 w-0 flex-1 pt-0.5">
                      ...
                      <div className="my-4">
                        <ExplorerLink
                          ...
                          className="text-sm font-medium text-zinc-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-50 focus:ring-zinc-600"
                        />
                      </div>
